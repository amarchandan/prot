...
var cards = [
  ...
  },
  {
    ...
    html: `
			<table>
				<tbody>
					<tr><td>KIDNAPPED RICH BITCH 🥺</td></tr>
				</tbody>
			</table>
		`,
  },
  {
    ...
    html: `<table>
			<tbody>
                ...
                <tr><td width="50%">Python</td><td>Rust</td></tr>
			</tbody>
		</table>`,
  },
  {
    ...
    html: `<table>
		...
		<tr><td>Linux (Shell Scripting & Administration Basics)</td></tr>
        <tr><td>Cybersecurity (Red Team, Blue Team, Yellow Team)</td></tr>
...
if (window.location.pathname === "/") {
  new Terminal({
    ...
    commands: [
      {
        text: 'load profile -firstName "Hoty" -lastName "segxy"',
        typing: true
      },
      {
        text: "loading...",
