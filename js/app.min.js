...
var cardPositions = {
  768: {
    profile: { zIndex: 11, top: 15, left: 17 },
    "face-capture": { zIndex: 7, top: 314, left: 242 },
    location: { zIndex: 2, top: 708, left: 27 },
    "known-associates": { zIndex: 8, top: 13, left: 425 },
    missions: { zIndex: 6, top: 77, left: 242 },
    training: { zIndex: 9, top: 684, left: 163 },
    languages: { zIndex: 3, top: 824, left: 492 },
    skillset: { zIndex: 10, top: 446, left: 53 },
    "audio-feed": { zIndex: 5, top: 1053, left: 343 },
    "server-log": { zIndex: 4, top: 980, left: 51 },
  },
  980: {
    profile: { zIndex: 11, top: 14, left: 19 },
    "face-capture": { zIndex: 6, top: 90, left: 349 },
    location: { zIndex: 2, top: 440, left: 19 },
    "known-associates": { zIndex: 7, top: 174, left: 235 },
    missions: { zIndex: 5, top: 20, left: 452 },
    training: { zIndex: 9, top: 444, left: 454 },
    languages: { zIndex: 10, top: 606, left: 701 },
    skillset: { zIndex: 8, top: 188, left: 704 },
    "audio-feed": { zIndex: 3, top: 697, left: 52 },
    "server-log": { zIndex: 4, top: 597, left: 471 },
  },
  1200: {
    profile: { zIndex: 11, top: 50, left: 25 },
    "face-capture": { zIndex: 6, top: 114, left: 230 },
    location: { zIndex: 2, top: 456, left: 116 },
    "known-associates": { zIndex: 7, top: 240, left: 589 },
    missions: { zIndex: 4, top: 60, left: 660 },
    training: { zIndex: 5, top: 426, left: 690 },
    languages: { zIndex: 9, top: 674, left: 416 },
    skillset: { zIndex: 10, top: 211, left: 892 },
    "audio-feed": { zIndex: 3, top: 730, left: 20 },
    "server-log": { zIndex: 8, top: 700, left: 768 },
  },
  1600: {
    profile: { zIndex: 11, top: 50, left: 54 },
    "face-capture": { zIndex: 4, top: 132, left: 380 },
    location: { zIndex: 2, top: 461, left: 119 },
    "known-associates": { zIndex: 7, top: 50, left: 1261 },
    missions: { zIndex: 8, top: 60, left: 629 },
    training: { zIndex: 6, top: 541, left: 1048 },
    languages: { zIndex: 10, top: 680, left: 1196 },
    skillset: { zIndex: 9, top: 298, left: 829 },
    "audio-feed": { zIndex: 3, top: 683, left: 40 },
    "server-log": { zIndex: 5, top: 671, left: 530 },
  },
};
...
var cards = [
  ...
  },
  {
    title: "Missions",
    width: 560,
    html: `<table><tbody><tr><td>KIDNAPPED RICH BITCH 🥺</td></tr></tbody></table>`
  },
  {
    title: "Languages",
    width: 250,
...
function touchstart(e) {
  ...
  if (!e.target.closest(".send-message") && !e.target.closest(".terminal")) {
    ...
    if (e.target.closest(".card-header") || e.target.closest(".modal-header")) {
      dragEl = e.target.closest(".card") || e.target.closest(".modal");
...
if (window.location.pathname === "/") {
  new Terminal({
    ...
    typingSpeed: 75,
    commands: [
      { text: 'load profile -firstName "Amar" -lastName "Chandan"', typing: true },
      { text: "loading...", typing: false },
    ],
    done: function () {
      setTimeout(function () {
        terminalWrap.style.display = "none";
        cardsContainer.style.visibility = "visible";
        positionCards(); // 👈 important fix
        setTimeout(function () {
  ...
  new Terminal({
    ...
    typingSpeed: 75,
    commands: [
      { text: "The page you were looking for does not exist", typing: true },
      { text: "How did you even get here?", typing: true },
      { text: '<a href="/">Go Home</a>', typing: false },
    ],
  });
}
...
function positionCards() {
  if (cardsContainer.offsetWidth > 480) {
    var width = cardsContainer.offsetWidth;

    // available breakpoints
    var breakpoints = Object.keys(cardPositions)
      .map(Number)
      .sort((a, b) => a - b);

    // default sabse chhota breakpoint
    var chosen = breakpoints[0];

    // jitne fit ho sakte hai unme sabse bada lo
    ...
    cardEls.forEach(function (card) {
      ...
      var cardObj = cardPositions[chosen][key];
      if (cardObj) {
...
var missions = {
  "nothing": `<p>Khud soch lu phele</p>`,
};
