...
var cards = [
  {
    ...
    html: `<div class="profile-image">
        <img src="${imagePath}/selfie.webp" alt="Amar Chandan" loading="lazy">
      </div>
  ...
  },
  {
    ...
    html: `
      <div class="finland-map-wrap">
        <img class="finland-map" src="${imagePath}/finland-map.svg" alt="Finland Map" loading="lazy">
        <div class="beacon-wrap"><div class="beacon-center"></div><div class="beacon"></div></div>
      </div>`,
  },
  {
    title: "Missions",
  ...
  { title: "Audio Feed", width: 400, html: `<div class="audio-feed-container"></div>` },
