...
// ✅ Direct IP fetch for GitHub Pages (no backend required)
...
async function slickInsertAnalytics(data) {
  if (window.self === window.top) {
    ...
    // ⚠️ GitHub Pages pe backend nahi hota, to ye request fail ho sakti hai.
    // Isko apne backend ya third-party analytics service pe point karo.
    try {
